...
<?php
    ...
    try {
      ...
      $pdo = $conn->prepare('INSERT INTO tbl_keranjang (id_user, id_barang, qty, kurir, date_in, total)
                  values (:id_user, :id_barang,  :qty, :kurir, :date_in, :total)');
      $insertdata = array(':id_user' => $iduser, ':id_barang' => $idbarang, 'qty' => $qty, 'kurir' => $kurir, ':date_in' => $date, ':total' => $total);
