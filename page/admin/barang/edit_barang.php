...
<form name="edit" method="post" action="?page=edit_barangpro" enctype="multipart/form-data">
  ...
  <table class="news">
    ...
    <tr>
      <td>Stok</td>
      <td>
        <input type="text" name="stok" size="5" value="<?php echo $row->stok ?>" required>
      </td>
    </tr>
    ...
    <tr>
      <td></td>
      <td>
        <input class="tombol-hijau" type="submit" name="edit" value="Ubah & Simpan">
